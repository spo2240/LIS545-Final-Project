The files included in this dataset are as follows. Files from the initial Kaggle dataset are stored in folder MAL_Top_10000 in their original, unedited form. Descriptions for csv files adapted from [kaggle dataset](https://www.kaggle.com/datasets/furkanark/myanimelist-top-10000-anime-dataset):
...
## datacite_mal.xml
This file contains metadata for the above documents using the DataCite Metadata Schema.  CoPilot AI was used to help craft this file, and then edited by me.
