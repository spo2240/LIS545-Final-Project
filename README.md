The files included in this dataset are as follows. Descriptions for csv files adapted from [kaggle dataset](https://www.kaggle.com/datasets/furkanark/myanimelist-top-10000-anime-dataset):
